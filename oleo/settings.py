...
SECRET_KEY = 'django-insecure-3634z67_w-b6)@t6(mbw)j=wf7^o&4eswc7ni#d^nq-0j6dyq!'
...
MIDDLEWARE = [
    ...
    'oleo.middleware.LoginRequiredMiddleware'
]
...
THUMBNAIL_ALIASES = {
    '': {
        ...
        'original': {'size': (1300, 1300), 'crop': False},
        'recipe_img': {'size': (800, 800), 'crop': False},
